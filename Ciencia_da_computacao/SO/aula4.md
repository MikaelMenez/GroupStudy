...
## Kernel monolítico 
é um grande bloco de código que implementa os serviços em modo kernel, mais simples de se implementar,mais performático, porém todo o sistema operacional atua em modo kernel 
...
# O que é Kernel?
no sistema operacional temos uma árvore de processos com uma raiz da árvore chamado de init, se ele for encerrado, toda a árvore se quebra, é o único processo que não é criado pelo usuário e sim pelo kernel 
...
quando um processo fica órfão, mesmo que o processo tenha se encerrado, o SO não consegue acessar esses recursos  
